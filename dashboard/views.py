...
client = OpenAI(
  ...
  api_key=settings.OPEN_AI_SECRETE_KEY,
)
...
def upload(request):
    ...
    if request.method == "GET":
        ...
        if "file" not in request.FILES:
            messages.error(request, "No files selected for upload.")  # Send an error message
        ...
        messages.success(request, "Files uploaded and tags generated successfully!")
